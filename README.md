...
> **Full screenshot documentation with detailed descriptions: [docs/SCREENSHOTS.md](docs/SCREENSHOTS.md)**

### Dashboard
<p align="center">
  <img src="docs/screenshots/01-dashboard-overview.png" alt="CompliAgent Dashboard" width="800" />
</p>

### Live Demo — x402 Agent Purchase (Real On-Chain Transaction)
<p align="center">
  <img src="docs/screenshots/03-flow1-x402-execution-pipeline.png" alt="x402 Agent Purchase Flow" width="800" />
</p>

### Live Demo — Affiliate Settlement (2 Real On-Chain Transactions)
<p align="center">
  <img src="docs/screenshots/06-flow2-affiliate-settlement-confirmed.png" alt="Affiliate Settlement Flow" width="800" />
</p>

### Monad Explorer — Transaction Verified ✅
<p align="center">
  <img src="docs/screenshots/07-monad-explorer-tx-verified.png" alt="Monad Explorer Transaction Verified" width="800" />
</p>

> Every transaction hash generated by CompliAgent is **real and verifiable** on [Monad Explorer](https://testnet.monadexplorer.com).
