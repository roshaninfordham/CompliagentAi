...
async function main() {
  ...
  // Use the V2 address
  const COMPLIANCE_REGISTRY = "0xC37a8f0ca860914BfAce8361Bf0621EAEa14863F";
  ...
  const rules = [
    ...
    { name: "Rate Limit",       ruleType: "rate_limit",        value: 100n, enabled: true },
    { name: "KYC Required",     ruleType: "kyc_check",         value: 1n,   enabled: false },
  ];
