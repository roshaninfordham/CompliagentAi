  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 bg-[#7C3AED] text-white px-4 py-2.5 rounded-lg hover:bg-[#6D28D9] transition-colors text-[13px]">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-card rounded-2xl border border-border w-full max-w-lg mx-4 shadow-xl">
            ...
            <div className="flex gap-3 p-5 border-t border-border">
              <button className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg bg-[#7C3AED] text-white text-[13px] hover:bg-[#6D28D9] transition-colors">
